...
class _$UsersRecord extends UsersRecord {
  ...
  _$UsersRecord._(
      {this.email, this.age, this.username, this.male, this.reference})
      : super._();
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc($jc(0, email.hashCode), age.hashCode), username.hashCode),
            male.hashCode),
        reference.hashCode));
  }
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  String _male;
  String get male => _$this._male;
  set male(String male) => _$this._male = male;
